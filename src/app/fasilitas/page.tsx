...
export default function FacilitiesPage() {
  const { facilities, profile } = useSchoolData();
        ...
        <section className="relative overflow-hidden bg-[#FCF8F1] py-10 lg:py-14 border-b border-[#E8E2D8]">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center max-w-3xl">
            ...
            <p className="text-sm sm:text-base text-stone-600 mt-3 leading-relaxed font-medium">
              Mendukung ekosistem belajar yang nyaman, higienis, berteknologi mutakhir, dan kondusif bagi santri untuk beribadah dan berkarya di {profile.name}.
            </p>
          </div>
        </section>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
            ...
            {filtered.length === 0 ? (
              <EmptyState
                ...
                description={
                  selectedCategory !== "Semua"
                    ? `Belum ada fasilitas yang tercatat dalam kategori "${selectedCategory}".`
                    : "Belum ada data fasilitas sarana prasarana yang dipublikasikan."
                }
                action={
                  selectedCategory !== "Semua"
                    ? {
                        label: "Tampilkan Semua Fasilitas",
