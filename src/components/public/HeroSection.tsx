      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
          ...
          <div className="lg:col-span-7 space-y-4 sm:space-y-5">
            ...
            {/* Pill Eyebrow */}
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#EAF9F9] border border-[#B8DEDE] text-[#006666] font-bold text-xs shadow-xs">
            ...
            <h1
              id="hero-heading"
              className="text-3xl sm:text-4xl lg:text-[2.65rem] font-extrabold text-[#1C1C1C] tracking-tight leading-[1.2]"
            >
              Belajar Lebih Tenang, <br className="hidden sm:inline" />
              Tumbuh Berkarakter <span className="text-primary underline decoration-[#008080]/30 decoration-wavy underline-offset-4">Qur&apos;ani</span>.
            </h1>

            {/* Welcoming Body copy */}
            <p className="text-sm sm:text-base text-stone-600 leading-relaxed max-w-xl">
              {profile.tagline} Di <strong className="font-bold text-[#1C1C1C]">{profile.name}</strong>, proses pendidikan memadukan kedalaman tradisi keilmuan Islam, tahfiz Al-Qur&apos;an 30 juz bersanad, penguasaan bahasa Arab &amp; Inggris aktif, serta kurikulum sains modern berbasis riset.
            </p>
          ...
          <div className="lg:col-span-5 relative mt-4 lg:mt-0">
            ...
            <div className="relative rounded-3xl overflow-hidden border-2 border-white bg-white shadow-xl">
              <div className="aspect-[4/3] sm:aspect-[16/11] relative max-h-[340px]">
                ...
                {/* Gradient overlay */}
                <div className="absolute inset-0 bg-gradient-to-t from-[#1C1C1C]/80 via-transparent to-black/10" />

                {/* Floating Pill Badge 1 — Top Right (Lilac) */}
                <div className="absolute top-3 right-3 animate-float">
                  <div className="px-3 py-1 rounded-xl bg-[#EAF9F9]/95 backdrop-blur-xs border border-[#DDD6FE] text-primary font-bold text-[11px] shadow-md flex items-center gap-1.5">
                ...
                <div className="absolute inset-x-3 bottom-3 p-3 rounded-2xl bg-white/95 backdrop-blur-xs border border-white shadow-lg">
                  <div className="flex items-center justify-between gap-2">
                    <div>
                      <span className="inline-block px-2 py-0.5 rounded-full bg-[#EAF9F9] text-primary text-[9px] font-extrabold uppercase tracking-wide">
                        Sekolah Terpadu
                      </span>
                      <h4 className="text-xs font-bold text-[#1C1C1C] mt-0.5">
                    ...
                    <div className="h-8 w-8 rounded-xl bg-primary text-white flex items-center justify-center font-bold text-xs shrink-0 shadow-xs">
