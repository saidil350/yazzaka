...
async function seed() {
  ...
  const programs = [
    {
      ...
      short_desc: "Bimbingan menghafal Al-Qur'an dengan metode talaqqi bersanad, mutqin tajwid, dan pemahaman tafsir praktis.",
      full_desc: "Program Tahfiz Al-Qur'an dirancang untuk membina santri menghafal 30 Juz secara bertahap selama masa studi.",
      image_url: "https://images.unsplash.com/photo-1584551246679-0daf3d275d0f?auto=format&fit=crop&w=1000&q=80",
      icon_name: "BookOpen",
      features: JSON.stringify(["Target mutqin 30 Juz dengan ijazah sanad", "Karantina Tahfiz Intensif menjelang liburan", "Kajian Tafsir Jalalain dan Hadits Arba'in", "Tasmi' Al-Qur'an bil Ghaib sekali duduk"]),
      target_competencies: JSON.stringify(["Hafal 30 Juz dengan makhraj & tajwid fasih", "Memahami kaidah bahasa Al-Qur'an", "Mampu menjadi imam rawatib & tarawih"]),
      status: "published",
      order_index: 1,
    },
    {
      ...
      short_desc: "Kurikulum penguatan STEM berbasis proyek riset terapan dan kecerdasan buatan.",
      full_desc: "Kelas unggulan yang mempersiapkan siswa menguasai sains analitis, komputasi modern, robotika, dan riset ilmiah remaja.",
      image_url: "https://images.unsplash.com/photo-1532094349884-543bc11b234d?auto=format&fit=crop&w=1000&q=80",
      icon_name: "Cpu",
      features: JSON.stringify(["Laboratorium sains canggih & IoT Workshop", "Klub Olimpiade Sains Nasional (OSN)", "Proyek Riset Ilmiah Remaja (KIR) tahunan", "Pelatihan dasar Coding & Artificial Intelligence"]),
      target_competencies: JSON.stringify(["Lolos seleksi olimpiade sains daerah/nasional", "Mampu menulis karya tulis ilmiah terpublikasi", "Penguasaan pemecahan masalah algoritma"]),
      status: "published",
      order_index: 2,
    },
    {
      ...
      short_desc: "Ekosistem bahasa aktif 24 jam dengan sertifikasi TOEFL/IELTS dan TOAFL resmi untuk studi lanjut luar negeri.",
      full_desc: "Menerapkan sistem Language Immersion Area. Seluruh santri dan civitas akademika berkomunikasi aktif menggunakan bahasa Arab dan Inggris.",
      image_url: "https://images.unsplash.com/photo-1523240795612-9a054b0db644?auto=format&fit=crop&w=1000&q=80",
      icon_name: "Globe",
      features: JSON.stringify(["Muhadharah (Public Speaking) mingguan", "Native speaker workshop & Arabic Camp", "Persiapan tes TOEFL ITP & TOAFL", "Program pertukaran pelajar internasional"]),
      target_competencies: JSON.stringify(["Skor TOEFL setara 550+ dan TOAFL setara Jayyid Jiddan", "Fasih berpidato dan berdebat dalam bahasa asing", "Kesiapan aplikasi beasiswa Al-Azhar, Timur Tengah & Barat"]),
      status: "published",
      order_index: 3,
    },
    {
      ...
      category: "Akademik",
      short_desc: "Kurikulum Merdeka Belajar terakreditasi A dipadukan dengan standar pengayaan akademik internasional.",
      full_desc: "Pembelajaran berpusat pada siswa dengan metodologi pembelajaran aktif, diferensiasi minat, dan persiapan matang menuju perguruan tinggi negeri favorit.",
      image_url: "https://images.unsplash.com/photo-1427504494785-3a9ca7044f45?auto=format&fit=crop&w=1000&q=80",
      icon_name: "GraduationCap",
      features: JSON.stringify(["Tryout UTBK-SNBT berkala sejak kelas 11", "Bimbingan studi lanjut ke PTN & PT Luar Negeri", "Kelas persiapan kedinasan & kedokteran", "Smart classroom dengan media interaktif"]),
      target_competencies: JSON.stringify(["Tembus 10 Perguruan Tinggi Negeri Terbaik", "Indeks Prestasi Akademik unggul", "Kemampuan literasi & numerasi tingkat tinggi"]),
      status: "published",
      order_index: 4,
    },
    {
      ...
      short_desc: "Pembinaan organisasi santri mandiri, kepramukaan bertaraf nasional, dan inkubasi wirausaha santri.",
      full_desc: "Santri dididik mengelola organisasi kesiswaan (OSIS/OPPM), kepanitiaan event besar, survival skill kepanduan, serta dasar-dasar kewirausahaan kreatif.",
      image_url: "https://images.unsplash.com/photo-1517245386807-bb43f82c33c4?auto=format&fit=crop&w=1000&q=80",
      icon_name: "Award",
      features: JSON.stringify(["Organisasi Pelajar Mandiri & Dewan Ambalan", "Perkemahan Akbar dan Ekspedisi Alam", "Business Plan Santri & Bazar Kewirausahaan", "Pelatihan Manajemen Organisasi & Retorika"]),
      target_competencies: JSON.stringify(["Kecakapan manajerial & kepemimpinan tim", "Jiwa pantang menyerah dan solutif", "Keterampilan komunikasi publik meyakinkan"]),
      status: "published",
      order_index: 5,
    },
  ];
  ...
  console.log("✓ programs seeded (5 records)");
